...
public class UnitOfWork : IUnitOfWork
{
    ...
    public UnitOfWork(GridBaseDbContext context)
    {
        _context = context;
    }
    ...
    private IGridBaseRepository _gridBaseRepository;
    public IGridBaseRepository GridBaseRepository =>
        _gridBaseRepository ??= new GridBaseRepository(_context);
