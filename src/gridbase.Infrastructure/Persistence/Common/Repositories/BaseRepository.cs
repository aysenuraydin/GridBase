...
namespace gridbase.Infrastructure.Persistence.Common.Repositories;
    ...
    where TEntity : class, IEntity<TKey>
{
    ...
    public BaseRepository(GridBaseDbContext context)
    {
        _context = context;
...
{
    public BaseRepository(GridBaseDbContext context) : base(context)
    {
    }
}
