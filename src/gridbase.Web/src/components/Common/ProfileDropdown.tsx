        ...
        <React.Fragment> 
            ...
            { user && <Dropdown isOpen={isProfileDropdown} style={{minWidth:"200px"}}
                ...
                <DropdownMenu className="dropdown-menu-end"> 
                        ...
                        <>
                            ...
                            <DropdownItem className='p-0'>
                                <Link to="/landing" className="dropdown-item">
                                    ...
                                    <span className="align-middle ms-1">{brand?.companyName || "Gridbase"}</span>
                                </Link>
                            </DropdownItem>
                            <DropdownItem className='p-0'>
                    ...
                    <DropdownItem className='p-0'>
                        <Link to="/gridbase" className="dropdown-item">
                            <i className="ri-grid-line text-muted fs-16 align-middle me-1"></i> 
                            <span className="align-middle">Gridbase</span>
                        </Link>
                    </DropdownItem>
                    <DropdownItem className='p-0'>
                    ...
                    { user ? (
                        <>
                            {user.roles[0]=="GB" &&
                                <>
                                <DropdownItem className='p-0'>
                                    <Link to="/menuItems" className="dropdown-item"> 
                                        <i className="bx bx-menu text-muted fs-16 align-middle me-1"></i> 
                                        <span className="align-middle">Menü</span>
                                    </Link>
                                </DropdownItem>
                                <DropdownItem className='p-0'>
