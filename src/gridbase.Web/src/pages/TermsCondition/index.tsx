...
const TermsCondition = () => { 
  ...
  document.title = "Kullanım Koşulları | " +(brand?.companyName || "Gridbase");
  
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Kullanım Koşulları" pageTitle={brand?.companyName || "Gridbase"} />
            ...
            <Col lg={10}>
              <Card>
                ...
                <CardBody className="p-4">
                  <div>
                    <h5>Gridbase'e Hoş Geldiniz!</h5>
                    <p className="text-muted">
                      Bu şartlar ve koşullar, gridbase.com adresinde bulunan Gridbase web sitesinin kullanımına ilişkin kuralları ve düzenlemeleri ana hatlarıyla belirtir.
                    </p>
                    <p className="text-muted">
                      Bu web sitesine erişerek, bu şartlar ve koşulları kabul ettiğinizi varsayıyoruz. Bu sayfada belirtilen tüm şart ve koşulları kabul etmiyorsanız Gridbase kullanmaya devam etmeyin.
                    </p>
                    <p className="text-muted">
                  ...
                  <div>
                    <h5>Lisans</h5>
                    <p className="text-muted">
                      Aksi belirtilmedikçe, Gridbase ve/veya lisans verenleri, Gridbase üzerindeki tüm materyallerin fikri mülkiyet haklarına sahiptir. Tüm fikri mülkiyet hakları saklıdır. Bu şartlar ve koşullarda belirlenen kısıtlamalara tabi olarak, kişisel kullanımınız için Gridbase üzerinden bu materyallere erişebilirsiniz.
                    </p>
                    <p className="text-muted">Aşağıdakileri yapmamalısınız:</p>
                    <ul className="text-muted vstack gap-2">
                      <li>Gridbase materyallerini yeniden yayımlamak</li>
                      <li>Gridbase materyallerini satmak, kiralamak veya alt lisanslamak</li>
                      <li>Gridbase materyallerini çoğaltmak, kopyalamak veya kopyasını çıkarmak</li>
                      <li>Gridbase içeriklerini yeniden dağıtmak</li>
                    </ul>
                    <p className="text-muted">
                      Bu Sözleşme, düzenlendiği tarih itibarıyla başlar.
                    </p>
                    <p className="text-muted">
                      Web sitemizin bazı bölümleri, kullanıcılara web sitesinin belirli alanlarında görüş ve bilgi paylaşma fırsatı sunar. Gridbase, yorumları web sitesinde yayınlanmadan önce filtrelemez, düzenlemez, yayımlamaz veya gözden geçirmez. Yorumlar, Gridbase'in, temsilcilerinin ve/veya iştiraklerinin görüş ve düşüncelerini yansıtmaz.
                    </p>
                  </div>

                  <div>
                    <p className="text-muted">
                      Gridbase, tüm Yorumları izleme ve uygunsuz, saldırgan bulunan veya bu Şart ve Koşulların ihlaline neden olan Yorumları kaldırma hakkını saklı tutar.
                    </p>
                    <p className="text-muted">
                    ...
                    <p className="text-muted">
                      İşbu belgeyle Gridbase'e, Yorumlarınızdan herhangi birini her türlü biçimde, formatta veya ortamda kullanma, çoğaltma, düzenleme ve başkalarının kullanması, çoğaltması ve düzenlemesi için yetkilendirme konusunda münhasır olmayan bir lisans verirsiniz.
                    </p>
                    <p className="text-muted">
                    ...
                    <p className="text-muted fw-semibold">
                      Bir ticari marka lisans sözleşmesi olmaksızın, Gridbase logosunun veya diğer görsellerinin bağlantı oluşturmak amacıyla kullanılmasına izin verilmeyecektir.
                    </p>
                  </div>
