...
const PrivacyPolicy = () => {
  ...
  document.title = "Gizlilik Politikası | " + (brand?.companyName || "Gridbase");

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Gizlilik Politikası" pageTitle={brand?.companyName || "Gridbase"} />
                ...
                <CardBody className="p-4">
                  <div className="d-flex">
                    ...
                    <div className="flex-grow-1">
                      <h5>Gridbase Gizlilik Politikası</h5>
                      <p className="text-muted">
                        gridbase.com adresinden erişilebilen Gridbase bünyesinde, ziyaretçilerimizin gizliliği temel önceliklerimizden biridir. 
                        Bu Gizlilik Politikası belgesi, Gridbase tarafından toplanan ve kaydedilen bilgi türlerini ve bunların nasıl kullanıldığını içermektedir.
                      </p>
                      <p className="text-muted">
                        Ek sorularınız varsa veya Gizlilik Politikamız hakkında daha fazla bilgiye ihtiyaç duyarsanız, support@gridbase.com adresinden bizimle e-posta yoluyla iletişime geçmekten çekinmeyin.
                      </p>
                      <p className="text-muted">
                        Bu gizlilik politikası yalnızca çevrimiçi faaliyetlerimiz için geçerlidir ve web sitemizi ziyaret eden kullanıcıların Gridbase ile paylaştığı ve/veya topladığı bilgiler için geçerlidir. 
                  ...
                  <div className="d-flex">
                    ...
                    <div className="flex-grow-1">
                      ...
                      <p className="text-muted">
                        Her etkileşimli konsol gibi Gridbase de 'çerezler' (cookies) kullanır. Bu çerezler, ziyaretçilerin tercihlerini ve ziyaretçinin eriştiği veya ziyaret ettiği web sitesindeki sayfaları içeren bilgileri depolamak için kullanılır. Bilgiler, ziyaretçilerin tarayıcı türüne ve/veya diğer bilgilere dayalı olarak web sayfası içeriğimizi özelleştirerek kullanıcı deneyimini optimize etmek için kullanılır.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="d-flex">
                    ...
                    <div className="flex-grow-1">
                      ...
                      <p className="text-muted">
                        <b>
                          Gridbase'in Gizlilik Politikası, diğer hizmetler veya bağlı harici araçlar için geçerli değildir. Bu nedenle, daha ayrıntılı bilgi için bu üçüncü taraf sistemlerin ilgili Gizlilik Politikalarına başvurmanızı tavsiye ederiz. 
