...
const About = () => {
    ...
    document.title = "Hakkımızda | " + (brand?.companyName || "Gridbase");

    const dummy =
        "https://dummyimage.com/1200x500/" +
        (isDark ? "031426" : "F3F6F9") + "/" +
        (isDark ? "fff" : "969696") + "&text=" + (brand?.companyName || "Gridbase");
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Hakkımızda" pageTitle={brand?.companyName || "Gridbase"} />
