...
const CoverSignUp = () => {
    ...
    document.title = "SignUp | " +(brand?.companyName || "Gridbase");
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Get your Free Gridbase account now.</p>
                                                </div>
                                                ...
                                                <Form
                                                        ...
                                                        <div className="mb-4">
                                                            <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Gridbase <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">{new Date().getFullYear()} Gridbase. Crafted with <i className="mdi mdi-heart text-danger"></i> by gridbase</p>
                                </div>
                            </div>
                        </div>
                    </Container>
